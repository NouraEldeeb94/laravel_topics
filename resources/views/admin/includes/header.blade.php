          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="{{route('users.admin')}}">All users</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('topic.add')}}">Add topic</a></li>
                <li>
                  <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="{{route('topic.admin')}}">All topics</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="{{route('category.admin')}}">All categories</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{route('testimonial.add')}}">Add testimonial</a></li>
                <li>
                  <hr class="dropdown-divider" />
                </li>
                <li><a class="dropdown-item" href="{{route('testimonial.admin')}}">All testimonials</a></li>
              </ul>
            </li>
            <li><a class="nav-item nav-link" href="{{route('messages.admin')}}">MESSAGES</a></li>
          </ul>
        </div>
      </div>
    </nav>
